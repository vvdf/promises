...
var getGitHubProfileAsync = user => new Promise((resolve, reject) => {
...
var generateRandomTokenAsync = () => new Promise((resolve, reject) => {
...
var readFileAndMakeItFunnyAsync = (filePath) => new Promise((resolve, reject) => {
